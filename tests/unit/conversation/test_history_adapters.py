import pytest
from FractalFlow.conversation.provider_adapters.openai_adapter import OpenAIHistoryAdapter
from FractalFlow.conversation.provider_adapters.deepseek_adapter import DeepSeekHistoryAdapter
