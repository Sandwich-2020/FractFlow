...
class TestOrchestrator:
    ...
    @mock.patch('FractalFlow.core.orchestrator.create_model')
    ...
    @mock.patch('FractalFlow.core.orchestrator.create_model')
    @mock.patch('FractalFlow.mcp.launcher.MCPLauncher')
    @mock.patch('FractalFlow.mcp.tool_loader.MCPToolLoader')
