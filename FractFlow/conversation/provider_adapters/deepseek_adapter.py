...
class DeepSeekHistoryAdapter(HistoryAdapter):
    ...
    def format_for_model(self, messages: List[Dict[str, Any]], tools: Optional[List[Dict[str, Any]]] = None) -> List[Dict[str, Any]]:
        """
        Format conversation history for DeepSeek models.
        ...
        Returns:
            Formatted conversation history for DeepSeek
        """
        formatted_messages = []
        tools_desc = None
        ...
        for i, message in enumerate(messages):
            ...
            if role == "system":
                ...
                # For DeepSeek, tool results need to be formatted as user messages
...
"""
    ...
    def _ensure_alternating_messages(self, messages: List[Dict[str, Any]]) -> None:
        ...
        This is needed for DeepSeek models which require strict alternation.
