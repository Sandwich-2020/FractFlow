...
Provides implementation of the BaseModel interface for QWEN models with native tool calling support.
"""
...
class QwenModel(BaseModel):
    """
    Implementation of BaseModel for QWEN models with native tool calling.
    
    Uses the OpenAI-compatible API provided by QWEN to leverage native tool calling capabilities.
    """
    ...
    def __init__(self, system_prompt: str = ""):
        ...
        self.model = config.get('qwen.model', 'qwen-plus')
