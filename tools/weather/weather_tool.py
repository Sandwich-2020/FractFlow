"""
Weather Tool - Unified Interface
...
Usage:
  python weather_tool.py                        # MCP Server mode (default)
  python weather_tool.py --interactive          # Interactive mode
  python weather_tool.py --query "..."          # Single query mode
"""
...
class WeatherTool(ToolTemplate):
    """Weather query tool using ToolTemplate"""
...
Note: This tool only supports weather queries for locations within the United States.
    ...
    def create_config(cls):
        """Custom configuration for Weather tool"""
