...
class GroundingDINOToolNew(ToolTemplate):
...
"""
    ...
    TOOLS = [
        ("tools/core/grounding_dino_new/grounding_dino_new_mcp.py", "grounding_dino_operations_new")
    ]
    
    MCP_SERVER_NAME = "grounding_dino_new_detection_tool"
