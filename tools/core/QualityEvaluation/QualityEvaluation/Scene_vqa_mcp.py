...
async def Scene_Evaluation_Vqa(image_path: str, prompt: str) -> str:
    ...
    Args:
        ...
        prompt (str): Text prompt describing what you want to know about the image. This can be:
                     - A direct question about the Object Positioning (e.g., "What objects are in this image?")
                     - An Analytical problem about the Object Scaling(e.g., "What is the relative size of the objects in the image compared to each other")
                     - A request for Overall Scene layout descripton(e.g., "Describe the overall layout of the scene )
                     - A specific Spatial Relationships (e.g., "proximity, containment, collision, separation")
